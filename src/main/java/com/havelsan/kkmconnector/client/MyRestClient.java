package com.havelsan.kkmconnector.client;
...
@Component
@NoArgsConstructor
public class MyRestClient implements ClientHttpRequestInterceptor, Closeable {
    private static final String JWT_TOKEN_HEADER_PARAM = "X-Authorization";
    protected RestTemplate restTemplate;

    @Value("${egys.restclient.endpoint}")
    ...
    public MyRestClient(RestTemplate restTemplate, String baseURL) {
    ...
    public TimePageData<AlarmInfo> getAlarms(EntityId entityId, AlarmSearchStatus searchStatus, AlarmStatus status, TimePageLink pageLink, Boolean fetchOriginator) {
        ...
        params.put("status", (status==null) ? "" : status.name());
        params.put("fetchOriginator", String.valueOf(fetchOriginator));
        this.addPageLinkToParam(params, (TimePageLink)pageLink);
        return (TimePageData)this.restTemplate.exchange(this.baseURL + "/api/alarm/{entityType}/{entityId}?searchStatus={searchStatus}&status={status}&fetchOriginator={fetchOriginator}&" + this.getUrlParams(pageLink), HttpMethod.GET, HttpEntity.EMPTY, new ParameterizedTypeReference<TimePageData<AlarmInfo>>() {
        }, params).getBody();
    }
    ...
    public TextPageData<Asset> getTenantAssets(TextPageLink pageLink, String assetType) {
        ...
        this.addPageLinkToParam(params, (TextPageLink)pageLink);
        ResponseEntity<TextPageData<Asset>> assets = this.restTemplate.exchange(this.baseURL + "/api/tenant/assets?type={type}&" + this.getUrlParams(pageLink), HttpMethod.GET, HttpEntity.EMPTY, new ParameterizedTypeReference<TextPageData<Asset>>() {
        }, params);
        return (TextPageData)assets.getBody();
    }
    ...
    public TextPageData<Asset> getCustomerAssets(CustomerId customerId, TextPageLink pageLink, String assetType) {
        ...
        params.put("type", assetType);
        this.addPageLinkToParam(params, (TextPageLink)pageLink);
        ResponseEntity<TextPageData<Asset>> assets = this.restTemplate.exchange(this.baseURL + "/api/customer/{customerId}/assets?type={type}&" + this.getUrlParams(pageLink), HttpMethod.GET, HttpEntity.EMPTY, new ParameterizedTypeReference<TextPageData<Asset>>() {
        }, params);
        return (TextPageData)assets.getBody();
    }
    ...
    public TimePageData<AuditLog> getAuditLogsByCustomerId(CustomerId customerId, TimePageLink pageLink, List<ActionType> actionTypes) {
        ...
        this.addPageLinkToParam(params, (TimePageLink)pageLink);
        ResponseEntity<TimePageData<AuditLog>> auditLog = this.restTemplate.exchange(this.baseURL + "/api/audit/logs/customer/{customerId}?actionTypes={actionTypes}&" + this.getUrlParams(pageLink), HttpMethod.GET, HttpEntity.EMPTY, new ParameterizedTypeReference<TimePageData<AuditLog>>() {
        }, params);
        return (TimePageData)auditLog.getBody();
    }
    ...
    public TimePageData<AuditLog> getAuditLogsByUserId(UserId userId, TimePageLink pageLink, List<ActionType> actionTypes) {
        ...
        params.put("actionTypes", this.listEnumToString(actionTypes));
        this.addPageLinkToParam(params, (TimePageLink)pageLink);
        ResponseEntity<TimePageData<AuditLog>> auditLog = this.restTemplate.exchange(this.baseURL + "/api/audit/logs/user/{userId}?actionTypes={actionTypes}&" + this.getUrlParams(pageLink), HttpMethod.GET, HttpEntity.EMPTY, new ParameterizedTypeReference<TimePageData<AuditLog>>() {
        }, params);
        return (TimePageData)auditLog.getBody();
    }
    ...
    public TimePageData<AuditLog> getAuditLogsByEntityId(EntityId entityId, List<ActionType> actionTypes, TimePageLink pageLink) {
        ...
        params.put("actionTypes", this.listEnumToString(actionTypes));
        this.addPageLinkToParam(params, (TimePageLink)pageLink);
        ResponseEntity<TimePageData<AuditLog>> auditLog = this.restTemplate.exchange(this.baseURL + "/api/audit/logs/entity/{entityType}/{entityId}?actionTypes={actionTypes}&" + this.getUrlParams(pageLink), HttpMethod.GET, HttpEntity.EMPTY, new ParameterizedTypeReference<TimePageData<AuditLog>>() {
        }, params);
        return (TimePageData)auditLog.getBody();
    }
    ...
    public TimePageData<AuditLog> getAuditLogs(TimePageLink pageLink, List<ActionType> actionTypes) {
        ...
        params.put("actionTypes", this.listEnumToString(actionTypes));
        this.addPageLinkToParam(params, (TimePageLink)pageLink);
        ResponseEntity<TimePageData<AuditLog>> auditLog = this.restTemplate.exchange(this.baseURL + "/api/audit/logs?actionTypes={actionTypes}&" + this.getUrlParams(pageLink), HttpMethod.GET, HttpEntity.EMPTY, new ParameterizedTypeReference<TimePageData<AuditLog>>() {
        }, params);
        return (TimePageData)auditLog.getBody();
    }
    ...
    public TextPageData<Customer> getCustomers(TextPageLink pageLink) {
        Map<String, String> params = new HashMap();
        this.addPageLinkToParam(params, (TextPageLink)pageLink);
        ResponseEntity<TextPageData<Customer>> customer = this.restTemplate.exchange(this.baseURL + "/api/customers?" + this.getUrlParams(pageLink), HttpMethod.GET, HttpEntity.EMPTY, new ParameterizedTypeReference<TextPageData<Customer>>() {
        }, params);
        return (TextPageData)customer.getBody();
    }
    ...
    public TextPageData<DashboardInfo> getTenantDashboards(TenantId tenantId, TextPageLink pageLink) {
        ...
        this.addPageLinkToParam(params, (TextPageLink)pageLink);
        return (TextPageData)this.restTemplate.exchange(this.baseURL + "/api/tenant/{tenantId}/dashboards?" + this.getUrlParams(pageLink), HttpMethod.GET, HttpEntity.EMPTY, new ParameterizedTypeReference<TextPageData<DashboardInfo>>() {
        }, params).getBody();
    }
    ...
    public TextPageData<DashboardInfo> getTenantDashboards(TextPageLink pageLink) {
        Map<String, String> params = new HashMap();
        this.addPageLinkToParam(params, (TextPageLink)pageLink);
        return (TextPageData)this.restTemplate.exchange(this.baseURL + "/api/tenant/dashboards?" + this.getUrlParams(pageLink), HttpMethod.GET, HttpEntity.EMPTY, new ParameterizedTypeReference<TextPageData<DashboardInfo>>() {
        }, params).getBody();
    }
    ...
    public TimePageData<DashboardInfo> getCustomerDashboards(CustomerId customerId, TimePageLink pageLink) {
        ...
        params.put("customerId", customerId.getId().toString());
        this.addPageLinkToParam(params, (TimePageLink)pageLink);
        return (TimePageData)this.restTemplate.exchange(this.baseURL + "/api/customer/{customerId}/dashboards?" + this.getUrlParams(pageLink), HttpMethod.GET, HttpEntity.EMPTY, new ParameterizedTypeReference<TimePageData<DashboardInfo>>() {
        }, params).getBody();
    }
    ...
    public List<DashboardInfo> findTenantDashboards() {
        try {
            ResponseEntity<TextPageData<DashboardInfo>> dashboards = this.restTemplate.exchange(this.baseURL + "/api/tenant/dashboards?limit=100000", HttpMethod.GET, (HttpEntity)null, new ParameterizedTypeReference<TextPageData<DashboardInfo>>() {
            }, new Object[0]);
            return ((TextPageData)dashboards.getBody()).getData();
        } catch (HttpClientErrorException var2) {
            if (var2.getStatusCode() == HttpStatus.NOT_FOUND) {
    ...
    public TextPageData<Device> getTenantDevices(String type, TextPageLink pageLink) {
        ...
        this.addPageLinkToParam(params, (TextPageLink)pageLink);
        return (TextPageData)this.restTemplate.exchange(this.baseURL + "/api/tenant/devices?type={type}&" + this.getUrlParams(pageLink), HttpMethod.GET, HttpEntity.EMPTY, new ParameterizedTypeReference<TextPageData<Device>>() {
        }, params).getBody();
    }
    ...
    public TextPageData<Device> getCustomerDevices(CustomerId customerId, String deviceType, TextPageLink pageLink) {
        ...
        this.addPageLinkToParam(params, (TextPageLink)pageLink);
        return (TextPageData)this.restTemplate.exchange(this.baseURL + "/api/customer/{customerId}/devices?type={type}&" + this.getUrlParams(pageLink), HttpMethod.GET, HttpEntity.EMPTY, new ParameterizedTypeReference<TextPageData<Device>>() {
        }, params).getBody();
    }
    ...
    public TextPageData<EntityView> getCustomerEntityViews(CustomerId customerId, String entityViewType, TextPageLink pageLink) {
        ...
        this.addPageLinkToParam(params, (TextPageLink)pageLink);
        return (TextPageData)this.restTemplate.exchange(this.baseURL + "/api/customer/{customerId}/entityViews?type={type}&" + this.getUrlParams(pageLink), HttpMethod.GET, HttpEntity.EMPTY, new ParameterizedTypeReference<TextPageData<EntityView>>() {
        }, params).getBody();
    }
    ...
    public TextPageData<EntityView> getTenantEntityViews(String entityViewType, TextPageLink pageLink) {
        ...
        params.put("type", entityViewType);
        this.addPageLinkToParam(params, (TextPageLink)pageLink);
        return (TextPageData)this.restTemplate.exchange(this.baseURL + "/api/tenant/entityViews?type={type}&" + this.getUrlParams(pageLink), HttpMethod.GET, HttpEntity.EMPTY, new ParameterizedTypeReference<TextPageData<EntityView>>() {
        }, params).getBody();
    }
    ...
    public TimePageData<Event> getEvents(EntityId entityId, String eventType, TenantId tenantId, TimePageLink pageLink) {
        ...
        params.put("tenantId", tenantId.getId().toString());
        this.addPageLinkToParam(params, (TimePageLink)pageLink);
        return (TimePageData)this.restTemplate.exchange(this.baseURL + "/api/events/{entityType}/{entityId}/{eventType}?tenantId={tenantId}&" + this.getUrlParams(pageLink), HttpMethod.GET, HttpEntity.EMPTY, new ParameterizedTypeReference<TimePageData<Event>>() {
        }, params).getBody();
    }
    ...
    public TimePageData<Event> getEvents(EntityId entityId, TenantId tenantId, TimePageLink pageLink) {
        ...
        params.put("tenantId", tenantId.getId().toString());
        this.addPageLinkToParam(params, (TimePageLink)pageLink);
        return (TimePageData)this.restTemplate.exchange(this.baseURL + "/api/events/{entityType}/{entityId}?tenantId={tenantId}&" + this.getUrlParams(pageLink), HttpMethod.GET, HttpEntity.EMPTY, new ParameterizedTypeReference<TimePageData<Event>>() {
        }, params).getBody();
    }
    ...
    public TextPageData<RuleChain> getRuleChains(TextPageLink pageLink) {
        Map<String, String> params = new HashMap();
        this.addPageLinkToParam(params, (TextPageLink)pageLink);
        return (TextPageData)this.restTemplate.exchange(this.baseURL + "/api/ruleChains?" + this.getUrlParams(pageLink), HttpMethod.GET, HttpEntity.EMPTY, new ParameterizedTypeReference<TextPageData<RuleChain>>() {
        }, params).getBody();
    }
    ...
    public TextPageData<Tenant> getTenants(TextPageLink pageLink) {
        Map<String, String> params = new HashMap();
        this.addPageLinkToParam(params, (TextPageLink)pageLink);
        return (TextPageData)this.restTemplate.exchange(this.baseURL + "/api/tenants?" + this.getUrlParams(pageLink), HttpMethod.GET, HttpEntity.EMPTY, new ParameterizedTypeReference<TextPageData<Tenant>>() {
        }, params).getBody();
    }
    ...
    public TextPageData<User> getTenantAdmins(TenantId tenantId, TextPageLink pageLink) {
        ...
        params.put("tenantId", tenantId.getId().toString());
        this.addPageLinkToParam(params, (TextPageLink)pageLink);
        return (TextPageData)this.restTemplate.exchange(this.baseURL + "/api/tenant/{tenantId}/users?" + this.getUrlParams(pageLink), HttpMethod.GET, HttpEntity.EMPTY, new ParameterizedTypeReference<TextPageData<User>>() {
        }, params).getBody();
    }
    ...
    public TextPageData<User> getCustomerUsers(CustomerId customerId, TextPageLink pageLink) {
        ...
        params.put("customerId", customerId.getId().toString());
        this.addPageLinkToParam(params, (TextPageLink)pageLink);
        return (TextPageData)this.restTemplate.exchange(this.baseURL + "/api/customer/{customerId}/users?" + this.getUrlParams(pageLink), HttpMethod.GET, HttpEntity.EMPTY, new ParameterizedTypeReference<TextPageData<User>>() {
        }, params).getBody();
    }
    ...
    public TextPageData<WidgetsBundle> getWidgetsBundles(TextPageLink pageLink) {
        Map<String, String> params = new HashMap();
        this.addPageLinkToParam(params, (TextPageLink)pageLink);
        return (TextPageData)this.restTemplate.exchange(this.baseURL + "/api/widgetsBundles?" + this.getUrlParams(pageLink), HttpMethod.GET, HttpEntity.EMPTY, new ParameterizedTypeReference<TextPageData<WidgetsBundle>>() {
        }, params).getBody();
    }
    ...
    private String getUrlParams(TextPageLink pageLink) {
        ...
        if (!StringUtils.isEmpty(pageLink.getIdOffset())) {
            urlParams = urlParams + "&idOffset={idOffset}";
        }

        if (!StringUtils.isEmpty(pageLink.getTextOffset())) {
            urlParams = urlParams + "&textOffset={textOffset}";
        }
