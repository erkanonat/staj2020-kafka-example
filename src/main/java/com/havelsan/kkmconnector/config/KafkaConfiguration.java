...
public class KafkaConfiguration {
    ...
    public ProducerFactory<String, String> producerFactory() {
        ...
        configProps.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, env.getProperty(BOOTSTRAP_SERVERS_CONFIG));
    ...
    public ConsumerFactory<String, String> consumerFactory(){
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, env.getProperty(GROUP_ID_CONFIG)+System.currentTimeMillis());
